...
public class PlayerController : MonoBehaviour
{
    ...
    {
        // Сначала проверяем, не является ли это NPC. Если да, выходим из функции.
        if (other.CompareTag("NPC"))
        {
            return; // Игнорируем этот триггер и ничего не делаем
        }

        // Если это не NPC, то продолжаем проверку на тип пола, как и раньше
